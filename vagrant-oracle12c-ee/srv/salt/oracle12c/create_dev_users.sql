...
-- 12.aug 2015 - v1.4 - Sigmund Ã˜rjavik    : Support for PDB, 
--                                           Increased APP_NAME to varchar(25)
-- 13.aug 2015 - v1.5 - Lasse Jenssen      : Common file for variables
--                                           Refactored design of script
-- 03.sep 2016 - v1.6 - Sigmund Ã˜rjavik    : Support for BIGFILE tablespaces
--                                           Support for profiles
-- 15.sep 2016 - v1.7 - Sigmund Ã˜rjavik    : Support for encrypted tablespaces
-- -------------------------------------------------------------------

-- Environment Variables is set by the user in the DEV_USERS_ENV.SQL script
@dev_users_env.sql &1 &2
